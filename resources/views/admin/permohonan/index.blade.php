                    ...
                    <tbody>
                        @foreach ($alat as $item)
                            <tr>
                                ...
                                <td>{{ date('d-m-Y', strtotime( $item->tgl_surat )) }}</td>
                                <td>{{ $item->perihal }}</td>
                                <td>{{ $item->utk_satuan }}</td>
                                <td>{{ $item->nm_domain }}</td>
                                <td>
                                  @if ($item->status == '1')
                                ...
                                <td class="text-right">
                                  <div class="btn-group">
                                    <a href="javascript:void(0)" id="showDetail" data-url="{{ route('permohonan.show', $item->id) }}" data-bs-toggle="modal" data-bs-target="#modal-detail" class="btn btn-sm btn-primary"><i class="fas fa-eye"></i></a>
                                    &nbsp;
                                    <a href="javascript:void(0)" id="viewMessage" data-url="{{ route('permohonan.show', $item->id) }}" data-bs-toggle="modal" data-bs-target="#modal-update" class="btn btn-sm btn-info"><i class="fas fa-pencil-alt"></i></a>
                                    &nbsp;
                                    <form id="delete-form-{{ $item->id }}" action="{{ route('permohonan.destroy', $item->id) }}" method="POST">
                                      @csrf
                                      @method('DELETE')
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="input-group col-md-6">
                            <label class="form-label">Nomor Permohonan : </label>&nbsp;
                            <div class="input-group-prepend">
                              <input type="text" id="no_mohon" name="no_mohon" class="form-control" readonly>
                            </div>
                          </div>
                          <div class="col-md-3">
                            <span>&nbsp;</span>
  ...
  $(document).ready(function(){
    $('body').on('click', '#viewMessage', function(){
        ...
        $.get(editURL, function(data){
            ...
            $('#modal-update #utk_satuan').val(data[0].kd_smkl).trigger('change');         
